...
public class GiftCertificateRepositoryImpl implements GiftCertificateRepository {
  ...
  @Override
  public int getMaxAvailableResultsOfGetListBySpecification(Specification specification) {
    CriteriaBuilder builder = em.getCriteriaBuilder();
    CriteriaQuery<GiftCertificate> criteriaQuery = specification.getCriteriaQuery(builder);
  ...
  @Override
  public int getMaxAvailableResultsOfGetListByUsersId(long id, String sort) {
    return em.createQuery(GET_GIFT_CERTIFICATES_BY_USERS_ID)
            .setParameter(1, id)
            .setParameter(2, sort)
            .getResultList().size();
